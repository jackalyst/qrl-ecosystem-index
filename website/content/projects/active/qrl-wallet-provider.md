...
gallery:
    - type: image
      path: qrl-wallet-provider/provider-architecture.jpg
      caption: Architecture overview showing a browser dApp connected to the QRL wallet extension through the wallet provider.
