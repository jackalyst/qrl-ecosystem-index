---
aliases:
    - /projects/active/qrl-mobile-wallet/
    - /projects/archived/qrl-mobile-wallet/
audited: false
audits: []
author: Volt Development
categories:
    - wallet
category: wallet
clients:
    - platform: android
      url: https://play.google.com/store/apps/details?id=com.volt.qrlmobile
      default: true
    - platform: ios
      url: https://apps.apple.com/app/qrl-mobile/id6448219494
created: "2026-08-17"
default_client:
    platform: android
    url: https://play.google.com/store/apps/details?id=com.volt.qrlmobile
    default: true
default_client_url: https://play.google.com/store/apps/details?id=com.volt.qrlmobile
...
features:
    - Send, receive, and manage QRL from Android and iOS devices
...
project_url: https://qrl-wallet.com/
qrl_versions:
    - 1.x
status: production
supported_networks:
